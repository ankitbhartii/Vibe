    ...
    <div className="min-h-screen bg-[#070708] flex items-center justify-center overflow-hidden font-sans relative p-4 select-none">
      ...
      >
        ...
        <div className="flex items-center justify-between w-full mt-4 mb-8">
          <Link href="/login" className="w-8 h-8 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white transition">
        ...
        <div className="flex flex-col gap-1.5 mb-6 px-1">
          <h2 className="text-[26px] font-bold text-white tracking-tight">Sign Up To Your Account.</h2>
          <p className="text-zinc-500 text-[13px]">Create a new Vibe account to start listening and streaming</p>
        </div>
        ...
        {/* The Form */}
        <form action={signup} className="flex flex-col gap-3.5 flex-1">
          {/* Email field */}
          ...
          <div className="flex flex-col gap-1 relative">
            <label className="text-[11px] font-bold uppercase tracking-wider text-zinc-500 pl-1">Confirm Password</label>
            <div className="relative w-full">
              <input 
        ...
        {/* Divider OR */}
        <div className="my-4 flex items-center gap-3 text-zinc-600 text-xs px-2">
        ...
        {/* Social Logins */}
        <div className="flex flex-col gap-2.5 px-1 mb-5">
          <button 
          ...
          <button 
            onClick={() => router.push('/signup?message=Apple signup is currently not available')} 
            className="w-full bg-zinc-950 border border-zinc-850 hover:bg-zinc-900 text-zinc-200 py-3 rounded-2xl font-bold flex items-center justify-center gap-3 transition text-sm cursor-pointer"
          >
        ...
        <div className="text-center text-xs text-zinc-500 mt-auto">
          ...
          <Link href="/login" className="text-[#ff2d55] hover:text-[#fc3c62] transition font-bold">
            Login
          </Link>
        </div>
      </motion.div>
